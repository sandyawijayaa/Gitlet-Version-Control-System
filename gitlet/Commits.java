...
public class Commits implements Serializable {
    ...
    /** SHA1 of the second parent. */
    private String _secParent;

    /** Treemap with key file (Object data type,
     * represents the file changed during said commit) and
     * value SHA1 (String data type, unique identifier of a commit). */
     ...
     */
    public Commits(String message, String parent,
    ...
    public Commits(String message, String parent,
            String secondp, TreeMap<String, String> files) {
        this._message = message;
        this._parent = parent;
        this._secParent = secondp;
        this._files = files;
        Date currently = new Date();
        SimpleDateFormat formatter
                = new SimpleDateFormat("E MMM dd HH:mm:ss yyyy Z");
