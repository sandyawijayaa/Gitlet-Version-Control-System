...
//    /**
//     * Branches treemap, with key branch name and value head commit's SHA1
//     */
//    private TreeMap<String, String> tree = new TreeMap<String, String>();
//
//    public Repo() {
//        CWD = new File (System.getProperty("user.dir")); // get prop
//        Utils.writeObject(BRANCHES_TREE, tree);
////        if (headFile.exists()) {
////            HEAD = headFile.getName().substring(0, headFile.getName().length() - 4);
////        }
...
//        // make master file
//        tree.put("master", defaultCommit.calcHash());
...
//        tree.put(currentBranchName, defaultCommit.calcHash());
...
//        tree.put(currentBranchName, newHash);
//
...
//        String headHash = tree.get(currentBranchName);
//        File currFile = Utils.join(COMMITS_FOLDER, headHash + ".txt");
//        Commits currentCommit = Utils.readObject(currFile, Commits.class);
//        return currentCommit;
//    }
//
//    public TreeMap<String, String> getCurrentBranch() {
//        File headFile = Utils.join(BRANCHES_FOLDER, "HEAD.txt");
//        TreeMap<String, String> currentBranch = Utils.readObject(headFile, TreeMap.class);
...
////        ArrayList<String> existingBranches = new ArrayList<>(tree.keySet());
...
////        existingBranches.remove(currentBranchName);
////        existingBranches.add("*" + currentBranchName);
...
//        List<String> remFiles = new ArrayList<>();
...
//        Object[] branches = tree.keySet().toArray();
...
//        String newCommitID = tree.get(branchName);
...
//            System.exit(0);
//        }
//        tree.put(branchName, getCurrentCommit().calcHash());
//        currentBranchName = branchName;
...
//            return;
//        }
//        tree.remove(branchName);
////        String currBranch = Utils.join(BRANCHES_FOLDER, "HEAD.txt");
...
//        tree.remove(currentBranchName);
//        tree.put(currentBranchName, commitID);
//    }
//
//    /**
